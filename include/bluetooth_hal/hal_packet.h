...
class HalPacket : public std::vector<uint8_t> {
  public:
    ...
    /**
     * @brief Set the transport of the packet. The transport is
     * TransportType::kDefault by default.
     *
     * @param transport The transport of the packet.
     *
     */
    void SetTransport(::bluetooth_hal::transport::TransportType transport) const {
        transport_ = transport;
    }

    /**
     * @brief Get the transport of the packet.
     *
     * @return The transport of the packet.
     *
     */
    ::bluetooth_hal::transport::TransportType GetTransport() const { return transport_; }
  ...
  private:
    ...
    mutable ::bluetooth_hal::transport::TransportType transport_ =
            ::bluetooth_hal::transport::TransportType::kDefault;
};
