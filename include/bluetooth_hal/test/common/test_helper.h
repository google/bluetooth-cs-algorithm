...
class MockPacketHandler {
  public:
    ...
    MOCK_METHOD(void, HalPacketCallback, (const ::bluetooth_hal::hci::HalPacket& packet));
...
class BaseMatcher : public ::testing::MatcherInterface<ActualType> {
  public:
     ...
     *
     */
    virtual bool MatchAndExplain(ActualType actual_value,
...
class MatcherFactory {
  public:
    ...
    static ::testing::Matcher<ActualType> CreateStringMatcher(ExpectedType expected_content) {
    ...
    static ::testing::Matcher<ActualType> CreateByteContentMatcher(ExpectedType expected_content,
                                                                   size_t expected_size) {
        return ::testing::MakeMatcher(
                new ByteContentMatcher<ExpectedType, ActualType>(expected_content, expected_size));
    }
     ...
     *
     */
    template <typename ExpectedType, typename ActualType = const std::vector<uint8_t>&>
    static ::testing::Matcher<ActualType> CreateVectorMatcher(ExpectedType expected_content) {
        return ::testing::MakeMatcher(
     ...
     *
     */
    template <typename ExpectedType, typename ActualType = const ::bluetooth_hal::hci::HalPacket&>
    static ::testing::Matcher<ActualType> CreateHalPacketMatcher(ExpectedType expected_content) {
        return ::testing::MakeMatcher(
                new VectorMatcher<ExpectedType, ActualType>(expected_content));
    }
};
