...
class Wakelock {
  public:
     ...
     *
     */
    virtual void Acquire(WakeSource source, ::bluetooth_hal::hci::HciPacketType type) = 0;

    /**
     * @brief Vote for acquiring wakelock from the system with unknown packet type.
     *
     * @param source The source of the requester.
     *
     */
...
class ScopedWakelock {
  public:
    ScopedWakelock(WakeSource source, ::bluetooth_hal::hci::HciPacketType type) : source_(source) {
