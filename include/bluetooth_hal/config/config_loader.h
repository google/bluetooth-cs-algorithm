...
class ConfigLoader {
  public:
     ...
     * false otherwise.
     */
    virtual bool LoadConfigFromFile([[maybe_unused]] std::string_view path) { return false; }
     ...
     * otherwise.
     */
    virtual bool LoadConfigFromString([[maybe_unused]] std::string_view content) { return false; }
