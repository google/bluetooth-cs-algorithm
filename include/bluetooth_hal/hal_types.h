...
class Property {
  public:
    ...
    static constexpr char kA2dpOffloadCap[] = "persist.bluetooth.a2dp_offload.cap";
    ...
    static constexpr char kTransportFallbackEnabled[] = "bluetooth.transport.fallback";
    ...
    static constexpr char kCsConfigFile[] = "persist.vendor.bluetooth.cs_config_path";

    // Transport properties.
    static constexpr char kUartPathOverride[] = "persist.vendor.bluetooth.uart_path_override";
    ...
    static constexpr char kBtVendorSnoopEnabledProperty[] = "persist.bluetooth.vendor.btsnoop";
...
enum class PacketSource : uint8_t { kNone, kController, kStack, kClient, kMax = kClient };
...
constexpr char kThreadDispatcherSocketPath[] = "/data/vendor/bluetooth/thread_dispatcher_socket";
 ...
 * ╠═══════════════╬═══════════════╬═══════════════════════════════════════╣
 * ║ kSnoopLogger  ║ Logger thread ║ Acquired when capturing packets into  ║
 * ║               ║               ║ the vendor snoop log.                 ║
 * ╠═══════════════╬═══════════════╬═══════════════════════════════════════╣
