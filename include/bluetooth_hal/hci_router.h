...
class HciRouter {
  public:
     ...
     *
     */
    virtual bool Initialize(const std::shared_ptr<HciRouterCallback>& callback) = 0;
     ...
     *
     */
    virtual bool SendCommand(const HalPacket& packet, const HalPacketCallback& callback) = 0;
